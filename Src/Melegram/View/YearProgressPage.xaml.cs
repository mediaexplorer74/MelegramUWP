...
namespace Melegram.View
{
    ...
    /// </summary>
    public sealed partial class YearProgressPage : Page
    {
        bool wasCopyButtonClicked = false;
        public YearProgressPage()
        {
...
*/
            ...
            YPViewModel.CopyButtonClicked += ViewModel_CopyButtonClicked;
        ...
        private void AnimateProgressBar()
        {
            ...
            int percentageToLoad = YPViewModel.YearProgress;
